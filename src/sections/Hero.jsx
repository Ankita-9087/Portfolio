...
export default function Hero() {
  return (
    <section id="home" className="hero-section min-h-screen px-6 py-24 flex items-center">
      <div className="hero-shell max-w-6xl mx-auto grid md:grid-cols-2 gap-8 items-center">
        <div className="hero-copy">
          <p className="hero-badge text-purple-300 font-semibold mb-4">
          ...
          <div className="contact-strip glass p-4 rounded-xl mt-8 max-w-xl">
            <p className="text-gray-300">averm242114@gmail.com</p>
            <p className="text-gray-300">93*******1</p>
            <p className="text-gray-300">
              Plot No 1374-E, Parvati Nagar, Tijori Chal, Nagpur, Maharashtra
              440027
            </p>
          </div>
        </div>
